    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExerciseBases", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DayPlans_Calendars_CalendarId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExerciseDuration = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercises_DayPlans_DayPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingredients_MealItems_MealItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyDoseLimits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DailyDoseLimits_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyDoseLimits_IngredientId",
                table: "DailyDoseLimits",
                column: "IngredientId");

            migrationBuilder.CreateIndex(
                name: "IX_DayPlans_CalendarId",
                table: "DayPlans",
                column: "CalendarId");

            migrationBuilder.CreateIndex(
                name: "IX_Exercises_DayPlanId",
                table: "Exercises",
                column: "DayPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_MealItemId",
                table: "Ingredients",
                column: "MealItemId");
